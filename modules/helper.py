...
def _point2adm2(loc):
    ...
    #max_adm_depth = min(len(address_component),2)
    #loc_adm_list = address_component[:max_adm_depth]
...
def point2adm2meta(loc):
    ...
    #adm1_name, adm2_name, areaid, loc_geom = None, None, None, None
    #for adm1_key, adm1_val in adm1_dict.items():
    #    if adm1_val.geometry.contains(loc_point):
    #        adm1_name = adm1_key
    #        if len(adm_level) < 3:
    #            areaid = adm1_val._areaid
    #            loc_geom = adm1_val.geometry
    #        else:
    #            adm2_dict = getattr(adm1_val, adm_level[2])
    #            for adm2_key, adm2_val in adm2_dict.items():
    #                if adm2_val.geometry.contains(loc_point):
    #                    adm2_name = adm2_key
    #                    areaid = adm2_val._areaid
    #                    loc_geom = adm2_dict[adm2_key].geometry
