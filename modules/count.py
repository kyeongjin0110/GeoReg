...
def count_area(loc, target_class, zoom_level=None, proxy_dir=None):
    """
    ...
    seg_path = proxy_dir / f'{ccode}_segmentation.json'
    ...
    data[areaid] = {}
    img_path_list = _point2adm2imgpathlist(loc, zoom_level, timeline='64776')
    #print(img_path_list)
